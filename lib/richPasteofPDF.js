    ...
    return {
        ...
        //读取路径
            ...
            //  const img = clipboard.readImage();
                ...
                // pdfpathread = pdfpathread.replace("\"","").replace("\"","");
                if (pdfpath=="" || pdfpath.substr(pdfpath.length-3,3)!="pdf") {
                    callback && callback(false);
                    // callback && callback(true, pdfpathread.substr(pdfpathread.length-3,3), pdfpathread);
                    return;
                }
